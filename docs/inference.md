...
| `audio_image2video` | text prompt + image + audio               | `vision.mp4` (with the conditioning audio muxed in)                                        | `prompt`, `vision_path`, `sound_path`       | —                                                                                                                                                                                                                                                                                                                                                                                                                       |
