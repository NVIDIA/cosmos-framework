// Math-warpgroup ping-pong (PP) variant of the INT8 port of DeepGEMM sm90_fp8_gemm_1d2d.cuh (MIT License, Copyright (c) 2025 DeepSeek).
...
// helpers (dispatch_num_former_iters, kPromoteMode / promote_i32, kOverlap) are shared with the default kernel
...
sm90_int8_gemm_1d2d_pp_impl(float* sfb, int* grouped_layout,
                        uint32_t shape_m, uint32_t shape_n, uint32_t shape_k,
    ...
    if (warp_idx >= kNumMathThreads / 32) {
        ...
        // (INT8 PP) math-warpgroup ping-pong: the two math warpgroups issue their WGMMA batches strictly alternately
