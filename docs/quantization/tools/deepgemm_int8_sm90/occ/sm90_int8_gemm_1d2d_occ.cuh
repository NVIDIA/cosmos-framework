...
// Generated by kernels/deepgemm_int8/occ/gen_kernel_occ.py from include/deep_gemm/impls/sm90_int8_gemm_1d2d.cuh -- do not edit by hand.
...
sm90_int8_gemm_1d2d_occ_impl(float* sfb, int* grouped_layout,
                        uint32_t shape_m, uint32_t shape_n, uint32_t shape_k,
