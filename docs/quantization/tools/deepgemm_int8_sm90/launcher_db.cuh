// Host launcher for the DB (double-buffered accumulator) variant: launcher.cuh with kernel sm90_int8_gemm_1d2d_db_impl.
...
void launch_db(const Args& args) {
    ...
    auto kernel = &deep_gemm::sm90_int8_gemm_1d2d_db_impl<
