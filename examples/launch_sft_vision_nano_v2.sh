...
# Dataflow-loader mirror of the VFM vision_sft_nano recipe (vision_sft_nano_v2)
...
#   RUN_NAME              default: vision_sft_nano_v2_<timestamp>
...
: "${RUN_NAME:=vision_sft_nano_v2_$(date +%Y%m%d_%H%M%S)}"
