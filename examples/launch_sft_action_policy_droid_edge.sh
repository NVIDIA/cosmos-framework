...
# ============================================================================
# Structured-TOML launch for DROID action-policy post-training on Cosmos3-Edge (2B MoT).
# Drives cosmos_framework.scripts.train against
# examples/toml/sft_config/action_policy_droid_edge.toml (selects the
# registered `action_policy_droid_edge` experiment; res480, joint_pos 8D +
# use_state, trains the generation + action heads and the qk-norm fix). See
