...
from typing_extensions import TYPE_CHECKING, Self, assert_never
...
from cosmos_framework.inference2._config import structure_config, undo_config_dict_replacements, unstructure_config
...
class CheckpointType(StrEnum):
    """Checkpoint type. Inlined from inference.common.args so inference2 is self-contained."""
