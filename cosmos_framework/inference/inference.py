...
class OmniInference(Inference):
    ...
    def _get_quantization_config(cls, setup_args: SetupArgs) -> QuantizationConfig:
        ...
        return QuantizationConfig(
            ...
            sim_edges=list(setup_args.quantization_sim_edges),
            sim_residual_group_size=setup_args.quantization_residual_group_size,
            sim_residual_bits=setup_args.quantization_residual_bits,
            sim_attn_v_block_size=setup_args.quantization_attn_v_block_size,
            sim_attn_smoothing=setup_args.quantization_attn_smoothing,
            sim_attn_v_format=setup_args.quantization_attn_v_format,
            sim_attn_p_format=setup_args.quantization_attn_p_format,
            sim_attn_pv_accum=setup_args.quantization_attn_pv_accum,
            sim_attn_k_scope=setup_args.quantization_attn_k_scope,
